...
let adjective = "super"
let noun = "car"
let place = "gas station"
let positiveEmotion = "excited"
let negativeEmotion = "grumpy"
let noun2 = "gas"
let fullStory = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(noun2)!"
/*:
